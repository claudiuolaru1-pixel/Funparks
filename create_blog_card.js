...
// Create blog_card widget
const blogCard=`import 'package:flutter/material.dart';
...
`;
fs.writeFileSync('lib/widgets/blog_card.dart',blogCard,'utf8');
console.log('Created blog_card.dart');